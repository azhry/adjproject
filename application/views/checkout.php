...
<div class="row">
	<div class="offset6 span6 right-align loginArea">
		...
		<a href="<?= base_url('home/register') ?>"><span class="btn btn-mini btn-success"> Register  </span></a> 
		<a href="<?= base_url('home/checkout') ?>"><span class="btn btn-mini btn-danger"> Cart [2] </span></a> 
	</div>
</div>
...
<div class="navbar-inner">
	<a class="brand" href="<?= base_url('') ?>"><img src="<?= base_url('themes/images/new_logo.png') ?>" alt="Bootsshop"></a>
...
<div class="footerMenu">
	<a href="<?= base_url('home/register') ?>"> REGISTRATION</a> | 
	<a href="<?= base_url('home/about_us') ?>"> ABOUT US</a> | 
	<a  href="<?= base_url('home/topology') ?>" >TOPOLOGY</a> | 
	<a href="<?= base_url('home/contact_us') ?>">CONTACT </a>
